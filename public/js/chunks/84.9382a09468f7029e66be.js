...
/* harmony import */ var _core_comp_functions_ui_app__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @core/comp-functions/ui/app */ "./resources/js/src/@core/comp-functions/ui/app.js");
/* harmony import */ var _ChatLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ChatLeftSidebar.vue */ "./resources/js/src/views/apps/chat/ChatLeftSidebar.vue");
/* harmony import */ var _chatStoreModule__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./chatStoreModule */ "./resources/js/src/views/apps/chat/chatStoreModule.js");
/* harmony import */ var _ChatActiveChatContentDetailsSidedbar_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ChatActiveChatContentDetailsSidedbar.vue */ "./resources/js/src/views/apps/chat/ChatActiveChatContentDetailsSidedbar.vue");
/* harmony import */ var _ChatLog_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ChatLog.vue */ "./resources/js/src/views/apps/chat/ChatLog.vue");
/* harmony import */ var _useChat__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./useChat */ "./resources/js/src/views/apps/chat/useChat.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    // SFC
    ChatLeftSidebar: _ChatLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    ChatActiveChatContentDetailsSidedbar: _ChatActiveChatContentDetailsSidedbar_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    ChatLog: _ChatLog_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  setup: function setup() {
    var CHAT_APP_STORE_MODULE_NAME = 'app-chat';

    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_2__["default"].hasModule(CHAT_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_2__["default"].registerModule(CHAT_APP_STORE_MODULE_NAME, _chatStoreModule__WEBPACK_IMPORTED_MODULE_9__["default"]);

    // UnRegister on leave
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_2__["default"].hasModule(CHAT_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_2__["default"].unregisterModule(CHAT_APP_STORE_MODULE_NAME);
    });
    var _useChat = Object(_useChat__WEBPACK_IMPORTED_MODULE_12__["default"])(),
      resolveAvatarBadgeVariant = _useChat.resolveAvatarBadgeVariant;

    // Scroll to Bottom ChatLog
    var refChatLogPS = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(null);
    ...
    // Chats & Contacts
    // ------------------------------------------------
    var chatsContacts = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])([]);
    var contacts = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])([]);
    var fetchChatAndContacts = function fetchChatAndContacts() {
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-chat/fetchChatsAndContacts').then(function (response) {
    ...
    // Single Chat
    // ------------------------------------------------
    var activeChat = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])({});
    var chatInputMessage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])('');
    var openChatOfContact = function openChatOfContact(userId) {
      // Reset send message input value
      chatInputMessage.value = '';
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-chat/getChat', {
        userId: userId
    ...
    var sendMessage = function sendMessage() {
      ...
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-chat/sendMessage', payload).then(function (response) {
        ...
        if (chat !== undefined) {
          ...
          chatsContacts.value.push(Object(_var_www_html_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(_var_www_html_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, activeChat.value.contact), {}, {
            chat: {
              id: chat.id,
    ...
    var profileUserData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])({});
    // ? Will contain id, name and avatar & status
    var profileUserDataMinimal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])({});
    var shallShowUserProfileSidebar = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(false);
    var showUserProfileSidebar = function showUserProfileSidebar() {
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-chat/getProfileUser').then(function (response) {
    ...
    var shallShowActiveChatContactSidebar = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(false);
    ...
    var startConversation = function startConversation() {
      if (_store__WEBPACK_IMPORTED_MODULE_2__["default"].state.app.windowWidth < _themeConfig__WEBPACK_IMPORTED_MODULE_6__["$themeBreakpoints"].lg) {
...
/* harmony import */ var _ChatContact_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ChatContact.vue */ "./resources/js/src/views/apps/chat/ChatContact.vue");
/* harmony import */ var _UserProfileSidebar_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./UserProfileSidebar.vue */ "./resources/js/src/views/apps/chat/UserProfileSidebar.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    var formattedChatData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["computed"])(function () {
      var contact = {
...
var useRouter = function useRouter() {
  ...
  return Object(_var_www_html_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(_var_www_html_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["toRefs"])(state)), {}, {
    router: vm.$router
  });
};
