...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_8__["default"].hasModule(MOU_ADD_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_8__["default"].registerModule(MOU_ADD_APP_STORE_MODULE_NAME, bookInStoreModule);
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n96 │ @import \"@core/scss/vue/libs/vue-select.scss\";\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  resources/js/src/views/mou/add/MouAdd.vue 96:9  root stylesheet");
