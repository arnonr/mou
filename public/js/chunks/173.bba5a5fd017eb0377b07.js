                                        ...
                                        _c(
                                          ...
                                          [
                                            _c(
                                              ...
                                              [_vm._v("หน่วยงาน(ต้นทาง) :")]
                                            ),
                                            _vm._v(" "),
                                            _c("span", [
                                              _vm._v(_vm._s(row.item.bookFrom)),
                                            ]),
                                          ]
                                        ),
                                        _vm._v(" "),
                                ...
                                _vm.showBtnAdmin
                                  ? _c(
                                      "b-button",
                                      {
                                        ...
                                        on: {
                                          click: function ($event) {
                                            return _vm.onConfirmDeleteActivity(
                                              row.item.id
                                            )
                                          },
                                        },
