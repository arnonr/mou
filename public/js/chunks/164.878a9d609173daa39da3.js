...
/* harmony import */ var _useProject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./useProject */ "./resources/js/src/views/project/useProject.js");
/* harmony import */ var _ProjectForm_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ProjectForm.vue */ "./resources/js/src/views/project/ProjectForm.vue");
/* harmony import */ var _projectStoreModule__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./projectStoreModule */ "./resources/js/src/views/project/projectStoreModule.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_3__["default"].hasModule(PROJECT_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_3__["default"].registerModule(PROJECT_APP_STORE_MODULE_NAME, _projectStoreModule__WEBPACK_IMPORTED_MODULE_6__["default"]);
    ...
    var _useProject = Object(_useProject__WEBPACK_IMPORTED_MODULE_4__["default"])(),
      fetchProjects = _useProject.fetchProjects,
      searchQuery = _useProject.searchQuery,
      blankMou = _useProject.blankMou,
...
function useProject() {
  ...
  var item = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(JSON.parse(JSON.stringify(blankPaper)));
  ...
  _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("project/fetchPaperTypes").then(function (response) {
  ...
  _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("project/fetchPaperStatuses").then(function (response) {
    var data = response.data.data;
  ...
  _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("project/fetchPIs").then(function (response) {
    var data = response.data.data;
  ...
  var fetchProjects = function fetchProjects(ctx, callback) {
    ...
    _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("project/fetchProjects", {
      year_id: _store__WEBPACK_IMPORTED_MODULE_5__["default"].state.project.year.id,
      sort_by: 'code'
    }).then(function (response) {
      var data = response.data.data;
      items.value = data.map(function (item) {
        var papers = item.papers.map(function (pItem) {
          var p = Object(_var_www_html_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_2__["default"])({}, pItem);
          if (p.file !== undefined && p.file !== null) {
          ...
          if (_store__WEBPACK_IMPORTED_MODULE_5__["default"].state.project.year.id == 1 || _store__WEBPACK_IMPORTED_MODULE_5__["default"].state.project.year.id == 2) {
            p.project = {
              label: item.code,
              code: item.id
            };
  ...
  var onSubmit = function onSubmit() {
    ...
    if (item.value.id == null) {
      _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("project/addPaper", dataSend).then( /*#__PURE__*/function () {
      ...
      _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("project/editProject", dataSend).then( /*#__PURE__*/function () {
  ...
  var onDelete = function onDelete() {
    sweetalert2__WEBPACK_IMPORTED_MODULE_8___default.a.fire({
      ...
      if (result.isConfirmed) {
        isOverLay.value = true;
        _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch("project/deletePaper", {
          id: item.value.id
  ...
  Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["watch"])(function () {
    return _store__WEBPACK_IMPORTED_MODULE_5__["default"].state.project.year.id;
  }, function (value) {
