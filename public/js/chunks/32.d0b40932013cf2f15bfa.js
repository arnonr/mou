...
/* harmony import */ var _auth_utils__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @/auth/utils */ "./resources/js/src/auth/utils.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var isAdmin = Object(_auth_utils__WEBPACK_IMPORTED_MODULE_19__["getUserData"])().type == "admin" ? true : false;
    var isStaff = Object(_auth_utils__WEBPACK_IMPORTED_MODULE_19__["getUserData"])().type == "staff" ? true : false;
    ...
    var simpleRules = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_16__["ref"])();
    ...
    var onConfirmActivityDelete = function onConfirmActivityDelete(id) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_10___default.a.fire({
        title: "Are you sure?",
        text: "You won't be able to revert this!",
        icon: "warning",
    ...
    var onActivityDelete = function onActivityDelete(id) {
      _store__WEBPACK_IMPORTED_MODULE_17__["default"].dispatch("mou-view/deleteActivity", {
        id: id
      }).then(function (response) {
        if (response.data.message == "success") {
          toast({
    ...
    var handleDeleteActivityClick = function handleDeleteActivityClick(id) {
      // activityItem.value = data;
    ...
    var onActivitySubmit = function onActivitySubmit() {
      ...
      if (activityItem.value.id == null) {
        ...
        _store__WEBPACK_IMPORTED_MODULE_17__["default"].dispatch("mou-view/editActivity", dataSend).then( /*#__PURE__*/function () {
