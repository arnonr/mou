...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var MOU_ADD_APP_STORE_MODULE_NAME = "mou-view";

    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_9__["default"].hasModule(MOU_ADD_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_9__["default"].registerModule(MOU_ADD_APP_STORE_MODULE_NAME, _mouStoreModule__WEBPACK_IMPORTED_MODULE_10__["default"]);

    // UnRegister on leave
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_9__["default"].hasModule(MOU_ADD_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_9__["default"].unregisterModule(MOU_ADD_APP_STORE_MODULE_NAME);
    });
    ...
    _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch("mou-add/fetchHosts").then(function (response) {
    ...
    _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch("mou-add/fetchCountries").then(function (response) {
      var data = response.data.data;
    ...
    var onSubmit = function onSubmit(ctx, callback) {
      ...
      _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch("mou-add/addMou", dataSend).then(function (response) {
