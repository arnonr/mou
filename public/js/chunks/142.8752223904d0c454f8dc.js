...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_11__["default"].hasModule(MOU_ADD_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_11__["default"].registerModule(MOU_ADD_APP_STORE_MODULE_NAME, _mouStoreModule__WEBPACK_IMPORTED_MODULE_12__["default"]);

    // UnRegister on leave
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_11__["default"].hasModule(MOU_ADD_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_11__["default"].unregisterModule(MOU_ADD_APP_STORE_MODULE_NAME);
    });
    var toast = Object(vue_toastification_composition__WEBPACK_IMPORTED_MODULE_8__["useToast"])();
    var simpleRules = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])();
    var overLay = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(false);
    var item = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["reactive"])({
      id: null,
      name: "",
      partner: "",
    ...
    _store__WEBPACK_IMPORTED_MODULE_11__["default"].dispatch("mou-add/fetchHosts").then(function (response) {
    ...
    _store__WEBPACK_IMPORTED_MODULE_11__["default"].dispatch("mou-add/fetchCountries").then(function (response) {
      var data = response.data.data;
    ...
    var onSubmit = function onSubmit(ctx, callback) {
      ...
      var dataSend = {
        ...
        partner_contact_email: item.value.partner_contact_email,
        host_contact_name: item.value.host_contact_name,
        host_contact_phone: item.value.host_contact_phone,
        host_contact_email: item.value.host_contact_email
      };
      _store__WEBPACK_IMPORTED_MODULE_11__["default"].dispatch("mou-add/addMou", dataSend).then(function (response) {
