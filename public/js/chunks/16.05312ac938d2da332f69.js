...
/* harmony import */ var dayjs_locale_th__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! dayjs/locale/th */ "./node_modules/dayjs/locale/th.js");
/* harmony import */ var dayjs_locale_th__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(dayjs_locale_th__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! dayjs/plugin/buddhistEra */ "./node_modules/dayjs/plugin/buddhistEra.js");
/* harmony import */ var dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony import */ var _mouStoreModule__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../mouStoreModule */ "./resources/js/src/views/mou/mouStoreModule.js");
...
dayjs__WEBPACK_IMPORTED_MODULE_12___default.a.extend(dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_14___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    dayjs: dayjs__WEBPACK_IMPORTED_MODULE_12___default.a,
  ...
  setup: function setup() {
    ...
    var showBtnAdmin = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["ref"])(true);

    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_16__["default"].hasModule(MOU_VIEW_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_16__["default"].registerModule(MOU_VIEW_APP_STORE_MODULE_NAME, _mouStoreModule__WEBPACK_IMPORTED_MODULE_17__["default"]);

    // UnRegister on leave
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_16__["default"].hasModule(MOU_VIEW_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_16__["default"].unregisterModule(MOU_VIEW_APP_STORE_MODULE_NAME);
    });
    var toast = Object(vue_toastification_composition__WEBPACK_IMPORTED_MODULE_8__["useToast"])();
    var overLay = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["ref"])(false);
    var isActivityModal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["ref"])(false);
    var isActivitySubmit = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["ref"])(false);
    ...
    var activityItems = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["ref"])([{
      name: "กิจกรรม1",
      detail: "กิจกรรม111111",
      activity_file: "https://bootstrap-vue.org/docs/components/table"
    }]);
    var activityItem = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["ref"])({
      name: "",
      detail: "",
      start_date: "",
      end_date: "",
    ...
    var item = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_15__["ref"])({
      id: null,
      name: "",
      partner: "",
    ...
    _store__WEBPACK_IMPORTED_MODULE_16__["default"].dispatch("mou-view/fetchMou", {
    ...
    var fetchActivities = function fetchActivities() {
      _store__WEBPACK_IMPORTED_MODULE_16__["default"].dispatch("mou-view/fetchActivities", {
        mou_id: _router__WEBPACK_IMPORTED_MODULE_7__["default"].currentRoute.params.id
      }).then(function (response) {
        var data = response.data.data;
    ...
    var onDelete = function onDelete(id) {
      _store__WEBPACK_IMPORTED_MODULE_16__["default"].dispatch("mou-view/deleteMou", {
        id: id
      }).then(function (response) {
    ...
    var onActivitySubmit = function onActivitySubmit() {
      ...
      if (activityItem.value.id == null) {
        _store__WEBPACK_IMPORTED_MODULE_16__["default"].dispatch("mou-view/addActivity", dataSend).then( /*#__PURE__*/function () {
        ...
        _store__WEBPACK_IMPORTED_MODULE_16__["default"].dispatch("mou-view/editActivity", dataSend).then( /*#__PURE__*/function () {
