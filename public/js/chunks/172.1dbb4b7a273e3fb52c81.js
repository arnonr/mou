...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-edit/fetchMou", {
      ...
      // item.partner_logo_file=data.partner_logo_file;
      // item.partner_logo_file_old = data.partner_logo_file;
      // item.mou_file_file=data.partner_logo_file;
      // item.mou_file_old= data.partner_logo_file;
      item.host_id = {
      ...
      item.partner_logo_file_old = data.partner_logo_file;
      item.old_mou_file = null;
      if (data.mou_file != null) {
        item.old_mou_file_old = data.mou_file;
      }
    })["catch"](function (error) {
      console.log(error);
      toast({
