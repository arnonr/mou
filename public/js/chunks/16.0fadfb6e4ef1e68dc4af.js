...
/* harmony import */ var _mouStoreModule__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../mouStoreModule */ "./resources/js/src/views/mou/mouStoreModule.js");
...
dayjs__WEBPACK_IMPORTED_MODULE_10___default.a.extend(dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_12___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    dayjs: dayjs__WEBPACK_IMPORTED_MODULE_10___default.a,
  ...
  setup: function setup() {
    ...
    var showBtnAdmin = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["ref"])(true);

    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_14__["default"].hasModule(MOU_VIEW_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_14__["default"].registerModule(MOU_VIEW_APP_STORE_MODULE_NAME, _mouStoreModule__WEBPACK_IMPORTED_MODULE_15__["default"]);

    // UnRegister on leave
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_14__["default"].hasModule(MOU_VIEW_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_14__["default"].unregisterModule(MOU_VIEW_APP_STORE_MODULE_NAME);
    });
    var toast = Object(vue_toastification_composition__WEBPACK_IMPORTED_MODULE_6__["useToast"])();
    var overLay = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["ref"])(false);
    var isActivityModal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["ref"])(false);
    var isActivitySubmit = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["ref"])(false);
    var activityFields = [{
      key: "name",
      label: "ชื่อกิจกรรม",
      sortable: true
    ...
    var activityItems = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["ref"])([{
      name: "กิจกรรม1",
      detail: "กิจกรรม111111",
      activity_file: "https://bootstrap-vue.org/docs/components/table"
    }]);
    var activityItem = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["ref"])({
      name: "",
      detail: "",
      start_date: "",
      end_date: "",
    ...
    var item = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_13__["ref"])({
      id: null,
      name: "",
      partner: "",
    ...
    _store__WEBPACK_IMPORTED_MODULE_14__["default"].dispatch("mou-view/fetchMou", {
    ...
    _store__WEBPACK_IMPORTED_MODULE_14__["default"].dispatch("mou-view/fetchActivities", {
      mou_id: _router__WEBPACK_IMPORTED_MODULE_5__["default"].currentRoute.params.id
    }).then(function (response) {
      var data = response.data.data;
    ...
    var onDelete = function onDelete(id) {
      _store__WEBPACK_IMPORTED_MODULE_14__["default"].dispatch("mou-view/deleteMou", {
        id: id
      }).then(function (response) {
