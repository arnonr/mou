...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var items = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])([]);
    var isOverLay = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(false);
    var perPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])({
      title: "10",
      code: 10
    });
    var currentPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(1);
    var totalPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(1);
    var totalItems = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(0);
    var orderBy = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])({
      title: "id",
      code: "id"
    });
    var order = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])({
      title: "DESC",
      code: "desc"
    });
    var admin = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(true);
    var advancedSearch = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["reactive"])({
      name: "",
      partner: "",
      host_id: null,
      country_code: null,
    ...
    _store__WEBPACK_IMPORTED_MODULE_10__["default"].dispatch("mou/fetchHosts").then(function (response) {
    ...
    _store__WEBPACK_IMPORTED_MODULE_10__["default"].dispatch("mou/fetchCountries").then(function (response) {
      var data = response.data.data;
