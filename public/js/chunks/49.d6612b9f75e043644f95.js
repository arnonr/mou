...
/* harmony import */ var dayjs_locale_th__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! dayjs/locale/th */ "./node_modules/dayjs/locale/th.js");
/* harmony import */ var dayjs_locale_th__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(dayjs_locale_th__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! dayjs/plugin/buddhistEra */ "./node_modules/dayjs/plugin/buddhistEra.js");
/* harmony import */ var dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_4__);
...
dayjs__WEBPACK_IMPORTED_MODULE_2___default.a.extend(dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_4___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_6__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_6__["default"].registerModule(USER_APP_STORE_MODULE_NAME, _userStoreModule__WEBPACK_IMPORTED_MODULE_7__["default"]);
                        ...
                        [
                          ...
                          _c(
                            "b-button",
                            {
                              ...
                              on: {
                                click: function ($event) {
                                  return _vm.$router.push({ name: "mou-add" })
                                },
                              },
                            },
                            [
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  actions: {
    ...
    editMou: function editMou(ctx, dataSend) {
      ...
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/mou/".concat(dataSend.id), form_data, {
          headers: {
            "content-type": "multipart/form-data"
          }
        }).then(function (response) {
    ...
    fetchActivities: function fetchActivities(ctx, queryParams) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/activity", {
          params: queryParams
        }).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
    ...
    // 
    addActivity: function addActivity(ctx, dataSend) {
      var form_data = new FormData();
      for (var key in dataSend) {
        form_data.append(key, dataSend[key]);
      }
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/activity", form_data, {
          headers: {
            "content-type": "multipart/form-data"
          }
        }).then(function (response) {
    ...
    editActivity: function editActivity(ctx, dataSend) {
      var form_data = new FormData();
      for (var key in dataSend) {
        form_data.append(key, dataSend[key]);
      }
      form_data.append("_method", "PUT");
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/activity/".concat(dataSend.id), form_data, {
          headers: {
            "content-type": "multipart/form-data"
          }
        }).then(function (response) {
    ...
    deleteActivity: function deleteActivity(ctx, _ref3) {
      var id = _ref3.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]("/activity/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
