...
/* harmony import */ var _views_project_projectStoreModule_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/views/project/projectStoreModule.js */ "./resources/js/src/views/project/projectStoreModule.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    _store__WEBPACK_IMPORTED_MODULE_8__["default"].registerModule(PROJECT_APP_STORE_MODULE_NAME, _views_project_projectStoreModule_js__WEBPACK_IMPORTED_MODULE_9__["default"]);
    var handleChangeYear = function handleChangeYear(val) {
      _store__WEBPACK_IMPORTED_MODULE_8__["default"].commit("project/SET_YEAR", val);
    };
    return {
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { staticClass: "text-center align-items-center ml-auto" },
        [
          _c(
            "b-button",
            {
              attrs: {
                variant:
                  _vm.store.state.project.year.id == 3 ? "success" : "info",
              },
              on: {
                click: function ($event) {
                  return _vm.handleChangeYear({
                    id: 3,
                    name: "2566",
                  })
                },
          ...
          _c(
            "b-button",
            {
              attrs: {
                variant:
                  _vm.store.state.project.year.id == 2 ? "success" : "info",
              },
              on: {
                click: function ($event) {
                  return _vm.handleChangeYear({
          ...
          _c(
            "b-button",
            {
              attrs: {
                variant:
                  _vm.store.state.project.year.id == 1 ? "success" : "info",
              },
              on: {
                click: function ($event) {
                  return _vm.handleChangeYear({
...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nError: ENOENT: no such file or directory, open '/var/www/html/resources/js/src/views/project/projectStoreModule.js'");
