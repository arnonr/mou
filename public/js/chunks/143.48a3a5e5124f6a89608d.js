...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-edit/fetchMou", {
      ...
      item.partner_contact_name = data.partner_contact_name ? data.partner_contact_name : "";
      item.partner_contact_phone = data.partner_contact_phone ? data.partner_contact_phone : "";
      item.partner_contact_email = data.partner_contact_email ? data.partner_contact_email : "";
      item.host_contact_name = data.host_contact_name ? data.host_contact_name : "";
      item.host_contact_phone = data.host_contact_phone ? data.host_contact_phone : "";
      item.host_contact_email = data.host_contact_email ? data.host_contact_email : "";
