                    ...
                    [
                      _c(
                        ...
                        [
                          _c(
                            "b-form-group",
                            { staticClass: "float-left", attrs: { cols: "2" } },
                            [
                              ...
                              _c("v-select", {
                                attrs: {
                                  dir: _vm.$store.state.appConfig.isRTL
                                    ...
                                    : "ltr",
                                  label: "title",
                                  options: _vm.selectOptions.per_page,
                                  clearable: false,
                                },
                                model: {
                                  value: _vm.advancedSearch.perPage,
                                  callback: function ($$v) {
                                    _vm.$set(_vm.advancedSearch, "perPage", $$v)
                                  },
                                  expression: "advancedSearch.perPage",
                                },
                              }),
                            ],
                            1
...
function useMou() {
  ...
  var perPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(10);
  ...
  var orderBy = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])("id");
  var order = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])("desc");
  ...
  var fetchItems = function fetchItems(ctx, callback) {
    ...
    var _orderBy = orderBy.value.toLowerCase();
    if (_orderBy == "start date") {
      _orderBy = "start_date";
    }
