...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var fetchItems = function fetchItems() {
      ...
      _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch("user/fetchUsers", {
    ...
    var onActivityDelete = function onActivityDelete(id) {
      _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch("mou-view/deleteActivity", {
        id: id
      }).then(function (response) {
    ...
    var onActivitySubmit = function onActivitySubmit() {
      ...
      if (activityItem.value.id == null) {
        _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch("mou-view/addActivity", dataSend).then( /*#__PURE__*/function () {
        ...
        _store__WEBPACK_IMPORTED_MODULE_9__["default"].dispatch("mou-view/editActivity", dataSend).then( /*#__PURE__*/function () {
