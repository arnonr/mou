  ...
  setup: function setup() {
    ...
    var onSubmit = function onSubmit(ctx, callback) {
      ...
      if (bookInData.bookTo) {
        bookToSend = bookInData.bookTo.map(function (x) {
      ...
      _store__WEBPACK_IMPORTED_MODULE_11__["default"].dispatch("book-in-add/addBookIn", dataSend).then(function (response) {
