...
/* harmony import */ var dayjs_locale_th__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! dayjs/locale/th */ "./node_modules/dayjs/locale/th.js");
/* harmony import */ var dayjs_locale_th__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(dayjs_locale_th__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! dayjs/plugin/buddhistEra */ "./node_modules/dayjs/plugin/buddhistEra.js");
/* harmony import */ var dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_10__);
...
dayjs__WEBPACK_IMPORTED_MODULE_8___default.a.extend(dayjs_plugin_buddhistEra__WEBPACK_IMPORTED_MODULE_10___default.a);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    dayjs: dayjs__WEBPACK_IMPORTED_MODULE_8___default.a,
  ...
  data: function data() {
    return {
      configDate: {
        ...
        altFormat: "d/m/Y",
        dateFormat: "Y-m-d",
        locale: flatpickr_dist_l10n_th_js__WEBPACK_IMPORTED_MODULE_2__["Thai"]
      }
    };
  },
  setup: function setup() {
    var MOU_VIEW_APP_STORE_MODULE_NAME = "mou-view";
    var showBtnAdmin = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])(true);

    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_12__["default"].hasModule(MOU_VIEW_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_12__["default"].registerModule(MOU_VIEW_APP_STORE_MODULE_NAME, _mouStoreModule__WEBPACK_IMPORTED_MODULE_13__["default"]);

    // UnRegister on leave
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_12__["default"].hasModule(MOU_VIEW_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_12__["default"].unregisterModule(MOU_VIEW_APP_STORE_MODULE_NAME);
    });
    ...
    var isActivityModal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])(false);
    var isActivitySubmit = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])(false);
    var activityFields = [{
      key: "name",
      label: "ชื่อกิจกรรม",
      sortable: true
    ...
    var activityItems = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])([{
      name: "กิจกรรม1",
      detail: "กิจกรรม111111",
      activity_file: "https://bootstrap-vue.org/docs/components/table"
    }]);
    var activityItem = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])({
      name: "",
      detail: "",
      start_date: "",
      end_date: "",
    ...
    var item = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])({
      id: null,
      name: "",
      partner: "",
    ...
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-view/fetchMou", {
    ...
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-view/fetchActivities", {
      mou_id: _router__WEBPACK_IMPORTED_MODULE_3__["default"].currentRoute.params.id
    }).then(function (response) {
      var data = response.data.data;
    ...
    var onDelete = function onDelete(id) {
      _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-view/deleteMou", {
        id: id
      }).then(function (response) {
