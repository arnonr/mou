...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_12__["default"].hasModule(MOU_ADD_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_12__["default"].registerModule(MOU_ADD_APP_STORE_MODULE_NAME, _mouStoreModule__WEBPACK_IMPORTED_MODULE_13__["default"]);

    // UnRegister on leave
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_12__["default"].hasModule(MOU_ADD_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_12__["default"].unregisterModule(MOU_ADD_APP_STORE_MODULE_NAME);
    });
    ...
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-add/fetchHosts").then(function (response) {
    ...
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-add/fetchCountries").then(function (response) {
      var data = response.data.data;
    ...
    var onSubmit = function onSubmit(ctx, callback) {
      overLay.value = true;
      var dataSend = Object(_var_www_html_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        ...
        partner_contact_name: item.value.partner_contact_name,
        partner_contact_phone: item.value.partner_contact_phone
      }, "partner_contact_name", item.value.partner_contact_name);
      _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("mou-add/addMou", dataSend).then(function (response) {
        ...
        if (response.data.message == "error Duplicate Book No") {
          bookNoLastest.value = "เลขทะเบียนรับล่าสุด : " + " " + (response.data.code.book_in + 1) + "/" + response.data.code.year;
        }
        overLay.value = false;
      })["catch"](function () {
        toast({
