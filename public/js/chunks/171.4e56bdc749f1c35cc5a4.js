            ...
            [
              ...
              _c("b-col", { attrs: { cols: "12" } }, [
                _c("span", { staticClass: "label" }, [
                  _vm._v("รูปโลโก้คู่สัญญา/Partner Logo: "),
                ]),
                _vm._v(
                  "\n        " + _vm._s(_vm.item.partner_logo_file) + "\n      "
                ),
              ]),
              _vm._v(" "),
              _c("b-col", { attrs: { cols: "12" } }, [
              ...
              _c("b-col", { attrs: { cols: "12" } }, [
                ...
                _vm._v(
                  "\n        " +
                    _vm._s(_vm.item.partner_contact_name) +
                    "\n      "
                ),
              ]),
              _vm._v(" "),
              _c("b-col", { attrs: { cols: "12" } }, [
                ...
                _vm._v(
                  "\n        " +
                    _vm._s(_vm.item.partner_contact_phone) +
                    "\n      "
                ),
              ]),
              _vm._v(" "),
              _c("b-col", { attrs: { cols: "12" } }, [
                ...
                _vm._v(
                  "\n        " +
                    _vm._s(_vm.item.partner_contact_email) +
                    "\n      "
                ),
              ]),
              _vm._v(" "),
